        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <div className="space-y-8">
              {[
                { icon: MapPin, title: "Our Office", details: ["Paseo Ricardo Commercial Center", "Nonoc, Rafael Rabaya Rd, Talisay", "Cebu, Philippines 6045"] },
                { icon: Mail, title: "Email Us", details: ["talisaychamber@gmail.com"] },
                { icon: Phone, title: "Call Us", details: ["09623184926"] },
